...
public class PasswordCheckerTest_STUDENT 
{
	...
	public void testIsValidPasswordTooShort()
	{
		...
		catch(NoUpperAlphaException | NoLowerAlphaException | NoDigitException | 
	...
	public void testIsValidPasswordNoUpperAlpha()
	{
		...
		catch(LengthException | NoLowerAlphaException | NoDigitException | 
				NoSpecialCharacterException | InvalidSequenceException e)
		{
			assertTrue("Threw a different exception", false);
		}
	...
	public void testIsValidPasswordNoLowerAlpha()
	{
		...
		catch(LengthException | NoUpperAlphaException | NoDigitException | 
				NoSpecialCharacterException | InvalidSequenceException e)
		{
			assertTrue("Threw a different exception", false);
		}
	...
	public void testIsValidPasswordInvalidSequence()
	{
		try 
		{
			assertTrue(PasswordCheckerUtility.isValidPassword("Aa11bbb#"));
		}
		catch(InvalidSequenceException e)
		{
			assertTrue("Successfully threw InvalidSequenceException", true);
				...
				NoSpecialCharacterException | NoLowerAlphaException e)
		{
			assertTrue("Threw a different exception", false);
		}
	}
	...
	public void testIsValidPasswordSuccessful()
	{
		try 
		{
			assertEquals(true, PasswordCheckerUtility.isValidPassword("myPassword2#"));
				...
				NoSpecialCharacterException | InvalidSequenceException | NoDigitException e)
		{
